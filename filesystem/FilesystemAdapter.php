...
use Blade\Http\UploadedFile;
use Blade\Support\Collection;
...
use Blade\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use Blade\Contracts\Filesystem\Filesystem as FilesystemContract;
use Blade\Contracts\Filesystem\FileNotFoundException as ContractFileNotFoundException;
...
class FilesystemAdapter implements FilesystemContract, CloudFilesystemContract
{
     ...
     * @return string
     *
     * @throws \Blade\Contracts\Filesystem\FileNotFoundException
     */
     ...
     *
     * @param  string  $path
     * @param  \Blade\Http\File|\Blade\Http\UploadedFile  $file
     * @param  array  $options
     * @return string|false
     */
